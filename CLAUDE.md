...
- [ ] **Pendientes (lista única y ordenada): ver `docs/STRAVA_ROADMAP.md` §"Pendientes por implementar"** — quedan: 🟢 backend **Fase 5 PR3 (visor web en vivo)** y **Fase 6 (social)**, y validación de campo (GPS reposo, auto-pausa).
