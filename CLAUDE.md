...
- [ ] **Pendientes (lista única y ordenada): ver `docs/STRAVA_ROADMAP.md` §"Pendientes por implementar"** — quedan: 🟡 cliente (detalle público con elevación interactiva, *snap* del planner, métricas DEM/nombres de zona), 🟢 backend **Fase 5 PR3 (visor web en vivo)** y **Fase 6 (social)**, y validación de campo (GPS reposo, auto-pausa).
